...
export const caseSearchApiDescription: INodeProperties[] = [
		{
			...
			"options": [
				...
				{
					"name": "Search Cases By Id",
					"value": "Search Cases By Id",
					"action": "Case search results for a given caseSearchId.",
					"description": "Retrieve the search results corresponding to the specified caseSearchId value.\n",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/caseSearch/{{$parameter[\"caseSearchId\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /caseSearch/{caseSearchId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
