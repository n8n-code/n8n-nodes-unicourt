...
export class UnicourtApi implements ICredentialType {
	name = 'N8nDevUnicourtApi';

	displayName = 'unicourt API';

	icon: Icon = { light: 'file:../nodes/Unicourt/unicourt.png', dark: 'file:../nodes/Unicourt/unicourt.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'https://enterpriseapi.unicourt.com/',
			required: true,
			placeholder: 'https://enterpriseapi.unicourt.com/',
			description: 'The base URL of your unicourt API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
